...
/**
 * The mod_assessment rubric updated event.
 *
...
/**
 * The mod_assessment rubric updated event class.
 *
 * @package    mod_assessment
 * @since      Moodle 2.7
 * @copyright  2014 Andy Chan
...
class rubric_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the rubric with id '$this->objectid' in the assessment activity
    ...
    public static function get_name() {
        return get_string('eventrubricupdated', 'mod_assessment');
    }
