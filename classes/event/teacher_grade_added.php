...
/**
 * The mod_assessment teacher grade added event.
 *
...
/**
 * The mod_assessment teacher grade added event class.
 *
 * @package    mod_assessment
 * @since      Moodle 2.7
 * @copyright  2014 Andy Chan
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class teacher_grade_added extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' added the teacher grade for student ($grade_target) in the assessment activity
    ...
    public static function get_name() {
        return get_string('eventteachergradeadded', 'mod_assessment');
    }
