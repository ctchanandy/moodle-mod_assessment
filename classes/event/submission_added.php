...
/**
 * The mod_assessment submission added event.
 *
...
/**
 * The mod_assessment submission added event class.
 *
 * @package    mod_assessment
 * @since      Moodle 2.7
 * @copyright  2014 Andy Chan
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class submission_added extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' added the submission with id '$this->objectid' of student ($grade_target) in the assessment activity
    ...
    public static function get_name() {
        return get_string('eventsubmissionadded', 'mod_assessment');
    }
