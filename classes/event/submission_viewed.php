...
/**
 * The mod_assessment submission viewed event.
 *
...
/**
 * The mod_assessment submission viewed event class.
 *
 * @package    mod_assessment
 * @since      Moodle 2.7
 * @copyright  2014 Andy Chan
...
class submission_viewed extends \core\event\base {
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' viewed the submission with id '$this->objectid' of student ($grade_target) in the assessment activity
    ...
    public static function get_name() {
        return get_string('eventsubmissionviewed', 'mod_assessment');
    }
