...
/**
 * A simple page to update gradebook and redirect
 *
 * @package     mod
...
// Force pushing existing assessment grades to gradebook when teacher click this link
assessment_update_grades(null, 0, $courseid);
