...
$string['postnotdiscussion'] = '這個帖了並不是討論主題的一部份。';
...
$string['notfindtopparent'] = '找不到屬於這個帖子討論主題的最頂層: {$a}';
$string['cannotreplypost'] = '你不能回覆這個帖子。';
$string['notpartofdiscussion'] = '這個帖子並不是討論主題的一部份。';
...
$string['erroradddiscussion'] = '不能加入討論主題到論壇';
$string['errormodifydiscussionauthor'] = '不能更改討論主題的作者';
...
// event names
$string['eventdiscussiondeleted'] = '刪除了一個討論主題';
$string['eventdiscussionviewed'] = '檢視了討論主題';
$string['eventdiscussionlistviewed'] = '檢視了討論主題列表';
$string['eventgradestudentviewed'] = '檢視了一位學生(或群組)的評分';
$string['eventsubmissionadded'] = '新增了一位學生(或群組)的功課';
$string['eventsubmissionformviewed'] = '檢視了一位學生(或群組)的功課表單';
$string['eventsubmissionupdated'] = '更新了一位學生(或群組)的功課';
$string['eventsubmissionviewed'] = '檢視了一位學生(或群組)的功課';
$string['eventteachergradeadded'] = '新增了一位學生(或群組)的老師評估';
$string['eventselfgradeadded'] = '新增了一位學生(或群組)的自我評估';
$string['eventpeergradeadded'] = '新增了一位學生(或群組)的同儕評估';
$string['eventteachergradeupdated'] = '更新了一位學生(或群組)的老師評估';
$string['eventselfgradeupdated'] = '更新了一位學生(或群組)的自我評估';
$string['eventpeergradeupdated'] = '更新了一位學生(或群組)的同儕評估';
$string['eventpostadded'] = '新增了一個帖子';
$string['eventpostdeleted'] = '刪除了一個帖子';
$string['eventpostupdated'] = '更新了一個帖子';
$string['eventrubriccreated'] = '新增了一個評量準則';
$string['eventrubricdeleted'] = '刪除了一個評量準則';
$string['eventrubricupdated'] = '更新了一個評量準則';